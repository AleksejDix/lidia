...
const icon = computed(() => {
  switch (type.value) {
    case 'error':
      return '<box-icon name="x-circle" type="regular"></box-icon>'
    case 'warning':
      return '<box-icon name="exclamation-circle" type="regular"></box-icon>'
    case 'success':
      return '<box-icon name="check-circle" type="regular"></box-icon>'
    case 'info':
    default:
